    ...
    render(){
        return(
            <div className="sidemenu-container">
                ...
                <h1 className="sidemenu-title">IL MEGLIO DI YOUTUBE</h1>
                ...
                <ul className="navigation">
                    ...
                    <li className="item">
                        <a>
                            <MaterialIcon icon="whatshot" size="small"/>
                    ...
                    <li className="item">
                        <a >
                            <MaterialIcon icon="games" size="small"/>
                    ...
                    <li className="item">
                        <a >
                            <MaterialIcon icon="local_movies" size="small"/>
                ...
                <div className="login-section">
                    <h2>  Accedi ora per vedere i tuoi canali e i consigli.</h2>
